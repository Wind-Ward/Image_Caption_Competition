    ...
    for epoch in range( start_epoch, args.num_epochs + 1 ):
        ...
        for i, (images, captions, lengths, _ ) in enumerate( data_loader ):
            ...
            if i % args.log_step == 0:
                ...
                #                                                                                  loss.data[0],
                #                                                                                  np.exp( loss.data[0] ) ))
                print('Epoch [%d/%d], Step [%d/%d], CrossEntropy Loss: %.4f' % (epoch,
                                                                               args.num_epochs,
                                                                               i, total_step,
                                                                               loss.data[0],
                                                                                ))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--vocab_path', type=str, default='/home/windward/symbolic_yangyi/PycharmProjects/AdaptiveAttentionCAption/data/vocab_ai_challenger_11.pkl',
                        help='path for vocabulary wrapper')
    parser.add_argument('--image_dir', type=str, default='/home/windward/symbolic_yangyi/PycharmProjects/AdaptiveAttentionCAption/data/image_resize_11/' ,
    ...
    parser.add_argument('--caption_val_json_path', type=str,
    ...
    parser.add_argument( '--batch_size', type=int, default=52) # on cluster setup, 60 each x 4 for Huckle server
    ...
    parser.add_argument( '--eval_json_out_dir', type=str, default='/home/windward/symbolic_yangyi/PycharmProjects/AdaptiveAttentionCAption/competition/model_1/result/', help='')

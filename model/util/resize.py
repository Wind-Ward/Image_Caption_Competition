...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_dir', type=str,
                        default='/home/windward/symbolic_yangyi/data/ai_challenger_caption_test_b_20171120/caption_test_b_images_20171120/',
                        help='directory for train images')
    parser.add_argument('--output_dir', type=str,
                        default='/home/windward/symbolic_yangyi/data/resized_test_b_30000',
                        help='directory for saving resized images')
    
    parser.add_argument('--image_size', type=int, default=256, # for cropping purpose
                        help='size for image_original_11 after processing')
